...
privilège. La coordination de ces agents par un orchestrateur
...
Le document s'organise en deux chapitres. Le chapitre~1 présente
les cadres d'orchestration d'agents, les techniques
d'augmentation par recherche et le Model Context Protocol, qui
constituent les fondations sur lesquelles s'appuie la conception
du système. Le chapitre~2 détaille cette conception~: indexation
des activités pédagogiques, protocole \gls{mcp} appliqué au
système et catalogue des agents retenus pour cette première
version.
