...
L'ancrage a précisément un coût observable. À l'échelle des trois
prompts rejoués, l'agent~2 consomme environ trois fois plus de
...
constat, plus que les valeurs absolues mesurées, qui motive le
chapitre suivant.
...
workflow et le contexte d'intégration. Le chapitre suivant prend en
charge cette stratégie : routage entre variantes, articulation des
...
Le chapitre~3 prend ces questions en charge. Il définit la stratégie
d'orchestration des variantes (politique de routage, articulation
des surfaces, mutualisation des sous-graphes communs), décrit le
dispositif d'observabilité associé (traces \gls{llm}, machine d'état
publique, métriques de débit et de latence), et adosse à ce
dispositif l'analyse de sécurité — surface d'attaque, contrôle
...
chapitre~3 organise leur coexistence.
