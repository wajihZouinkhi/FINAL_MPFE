...
Une introduction situe le projet dans son contexte. Le chapitre~1 présente
les motifs d'orchestration d'agents, l'augmentation par recherche et le Model
Context Protocol. Le chapitre~2 détaille la conception~: indexation vectorielle
des activités, protocole \gls{mcp} appliqué au système, catalogue des agents
retenus et lecture comparative des implémentations livrées. Le chapitre~2 se
clôt en annonçant le \textbf{chapitre~3}, qui en constitue la suite~: stratégie
d'orchestration des variantes, observabilité et sécurité applicative. Une
conclusion générale clôt la présente version du document.
